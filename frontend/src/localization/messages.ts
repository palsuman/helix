...
export const messages = defineMessages({
  ...
  quickOpenTitle: { id: "quickOpen.title", defaultMessage: "Quick Open" },
  quickOpenSearch: { id: "quickOpen.search", defaultMessage: "Search files and symbols" },
  quickOpenPlaceholder: { id: "quickOpen.placeholder", defaultMessage: "Search files by name" },
  quickOpenClose: { id: "quickOpen.close", defaultMessage: "Close Quick Open" },
  quickOpenLoading: { id: "quickOpen.loading", defaultMessage: "Searching..." },
  quickOpenEmpty: { id: "quickOpen.empty", defaultMessage: "No matching results" },
  quickOpenIndexing: {
    id: "quickOpen.indexing",
    defaultMessage: "Indexing workspace; showing results from a directory scan.",
  },
  quickOpenNoWorkspace: { id: "quickOpen.noWorkspace", defaultMessage: "No workspace is open." },
  quickOpenNoSymbolProvider: {
    id: "quickOpen.noSymbolProvider",
    defaultMessage: "No symbol provider is available for the active language.",
  },
  quickOpenLineHint: { id: "quickOpen.lineHint", defaultMessage: "Enter a line number." },
  quickOpenGoToLine: {
    id: "quickOpen.goToLine",
    defaultMessage: "Go to line {line}",
  },
  quickOpenFooter: {
    id: "quickOpen.footer",
    defaultMessage:
      "Enter to open · Ctrl+Enter to open in a split · @ symbols · # workspace symbols · : line · > commands",
  },
  quickOpenPathDescription: {
    id: "quickOpen.pathDescription",
    defaultMessage: "{root} · {path}",
  },
  quickOpenSymbolDescription: {
    id: "quickOpen.symbolDescription",
    defaultMessage: "{detail}:{line}",
  },
  ...
  commandQuickOpen: {
    id: "command.workbench.action.quickOpen.title",
  ...
  workspaceSearchUnpin: { id: "workspace.searchUnpin", defaultMessage: "Unpin results" },
  workspaceSearchQuery: { id: "workspace.searchQuery", defaultMessage: "Search query" },
  workspaceSearchQueryPlaceholder: {
    id: "workspace.searchQueryPlaceholder",
    defaultMessage: "Search workspace",
  },
  workspaceSearchReplacement: { id: "workspace.searchReplacement", defaultMessage: "Replacement" },
  workspaceSearchReplacementPlaceholder: {
    id: "workspace.searchReplacementPlaceholder",
    defaultMessage: "Replace with",
  },
  workspaceSearchInclude: { id: "workspace.searchInclude", defaultMessage: "Include glob" },
  workspaceSearchIncludePlaceholder: {
    id: "workspace.searchIncludePlaceholder",
    defaultMessage: "Include: **/*.ts",
  },
  workspaceSearchExclude: { id: "workspace.searchExclude", defaultMessage: "Exclude glob" },
  workspaceSearchExcludePlaceholder: {
    id: "workspace.searchExcludePlaceholder",
    defaultMessage: "Exclude: **/vendor/**",
  },
  workspaceSearchGitignore: {
    id: "workspace.searchGitignore",
    defaultMessage: "Respect gitignore",
  },
  ...
  workspaceSearchReplaceSelected: {
    id: "workspace.searchReplaceSelected",
  ...
  workspaceSearchNoWorkspace: {
    id: "workspace.searchNoWorkspace",
    defaultMessage: "Open a workspace to search its files.",
  },
  workspaceSearchDismiss: {
    id: "workspace.searchDismiss",
    defaultMessage: "Dismiss result {location}",
  },
  workspaceSearchCollapse: {
    id: "workspace.searchCollapse",
    defaultMessage: "Collapse file results",
  },
  workspaceSearchExpand: { id: "workspace.searchExpand", defaultMessage: "Expand file results" },
  workspaceSearchPreviewBefore: { id: "workspace.searchPreviewBefore", defaultMessage: "Before" },
  workspaceSearchPreviewAfter: { id: "workspace.searchPreviewAfter", defaultMessage: "After" },
  workspaceSearchProgress: {
    id: "workspace.searchProgress",
    defaultMessage: "Search operation in progress",
  },
  workspaceSearchPreviewResults: {
    id: "workspace.searchPreviewResults",
    defaultMessage: "Replacement preview",
  },
  workspaceSearchPinnedResults: {
    id: "workspace.searchPinnedResults",
    defaultMessage: "Pinned results for {query}",
  },
  workspaceSearchPreviewFile: {
    id: "workspace.searchPreviewFile",
    defaultMessage: "{path} ({count})",
  },
  workspaceSearchExpandGlyph: { id: "workspace.searchExpandGlyph", defaultMessage: "+" },
  workspaceSearchCollapseGlyph: { id: "workspace.searchCollapseGlyph", defaultMessage: "−" },
  workspaceSearchDismissGlyph: { id: "workspace.searchDismissGlyph", defaultMessage: "×" },
  ...
  helixLogo: { id: "brand.helixLogo", defaultMessage: "Helix IDE" },
  explorerNewFile: { id: "explorer.newFile", defaultMessage: "New file" },
  explorerNewFolder: { id: "explorer.newFolder", defaultMessage: "New folder" },
  explorerRefresh: { id: "explorer.refresh", defaultMessage: "Refresh explorer" },
  explorerCollapse: { id: "explorer.collapse", defaultMessage: "Collapse all" },
  explorerFilter: { id: "explorer.filter", defaultMessage: "Filter files and folders" },
  explorerName: { id: "explorer.name", defaultMessage: "File or folder name" },
  explorerDestination: { id: "explorer.destination", defaultMessage: "Destination folder path" },
  explorerInvalidName: { id: "explorer.invalidName", defaultMessage: "Enter a name without path separators; dot and dot-dot are not allowed." },
  explorerUnreadable: { id: "explorer.unreadable", defaultMessage: "{count} paths could not be read." },
  explorerApply: { id: "explorer.apply", defaultMessage: "Apply" },
  explorerCancel: { id: "explorer.cancel", defaultMessage: "Cancel" },
  explorerOpen: { id: "explorer.open", defaultMessage: "Open" },
  explorerRename: { id: "explorer.rename", defaultMessage: "Rename" },
  explorerMove: { id: "explorer.move", defaultMessage: "Move to folder…" },
  explorerDuplicate: { id: "explorer.duplicate", defaultMessage: "Duplicate" },
  explorerDelete: { id: "explorer.delete", defaultMessage: "Delete" },
  explorerDeleteConfirm: { id: "explorer.deleteConfirm", defaultMessage: "Permanently delete {count} selected items and their contents? This cannot be undone." },
  explorerCopyPath: { id: "explorer.copyPath", defaultMessage: "Copy path" },
  explorerCopyRelative: { id: "explorer.copyRelative", defaultMessage: "Copy relative path" },
  explorerRevealOS: { id: "explorer.revealOS", defaultMessage: "Reveal in file manager" },
  explorerReveal: { id: "command.workbench.action.revealInExplorer.title", defaultMessage: "Reveal in Explorer" },
  explorerDiagnostics: { id: "explorer.diagnostics", defaultMessage: "{count} diagnostics" },
